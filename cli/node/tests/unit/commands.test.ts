...
import { setAgentMode } from '../../src/runtime/state.js';
import { createMockBackend } from '../helpers/backend.js';
...
describe('cmdAdd', () => {
  it('adds text memory', async () => {
    const { cmdAdd } = await import('../../src/cli/commands/memory/add.js');
...
describe('cmdSearch', () => {
  it('searches and shows results in text mode', async () => {
    const { cmdSearch } = await import('../../src/cli/commands/memory/search.js');
...
describe('cmdGet', () => {
  it('gets memory in text mode', async () => {
    const { cmdGet } = await import('../../src/cli/commands/memory/get.js');
...
describe('cmdList', () => {
  it('lists in table mode', async () => {
    const { cmdList } = await import('../../src/cli/commands/memory/list.js');
...
describe('cmdUpdate', () => {
  it('updates memory', async () => {
    const { cmdUpdate } = await import('../../src/cli/commands/memory/update.js');
...
describe('cmdDelete', () => {
  it('deletes memory', async () => {
    const { cmdDelete } = await import('../../src/cli/commands/memory/delete.js');
...
describe('cmdDeleteAll', () => {
  it('deletes all with force', async () => {
    const { cmdDeleteAll } = await import('../../src/cli/commands/memory/delete-all.js');
...
describe('cmdEntitiesList', () => {
  it('lists users in table mode', async () => {
    const { cmdEntitiesList } = await import('../../src/cli/commands/entities.js');
...
describe('cmdEventList', () => {
  it('lists events in table mode', async () => {
    const { cmdEventList } = await import('../../src/cli/commands/events.js');
...
describe('cmdEventStatus', () => {
  it('shows event details in text mode', async () => {
    const { cmdEventStatus } = await import('../../src/cli/commands/events.js');
