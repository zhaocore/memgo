---
name: pause
description: Pause MemGo memory capture on this machine. Use when the user wants to stop memories being recorded, for example for private work or experiments.
...
local telemetry record still fires at session start unless
