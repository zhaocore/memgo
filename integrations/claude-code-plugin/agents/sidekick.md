...
model: sonnet
effort: medium
tools: Read, Grep, Glob, Bash, Edit, Write, WebFetch, WebSearch, Monitor, SendMessage, Skill, mcp__plugin_memgo_memgo__search_memories
isolation: worktree
color: cyan
---

You are MemGo's Sonnet coding agent. Complete the work the main agent gives you.
