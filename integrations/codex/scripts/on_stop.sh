...
# Hook: Stop
#
# Captures a structured session summary when a session ends.
# Parses the transcript, extracts the last assistant message and files
# touched, then stores via MemGo OSS API with infer=True for AI extraction.
#
# Guards:
...
# Honor auto_save=false in ~/.memgo/settings.json
